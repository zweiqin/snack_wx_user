			...
			<view class="item" v-for="(item, index) in list" :key="index">
				...
				<view class="operation acea-row row-between-wrapper">
					...
					<view class="acea-row row-middle">
						...
						<navigator class="bnt" v-if="where.status == 1 && item.shipping_type === 1 && (item.pinkStatus === null || item.pinkStatus === 2)" :url="'/pages/admin/delivery/index?id='+item.order_id">去发货
						</navigator>
					</view>
				</view>
			</view>
