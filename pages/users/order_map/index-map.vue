<template>
	<view class="server-place">
		...
		<!-- #ifndef APP-PLUS -->
		<cover-image :style="{left: controlsLeft + 'px', top: controlsTop + 'px'}" class="controls-location" :src="positionIcon"></cover-image>
		<!-- #endif -->
		...
		<view class="map-tools">
			...
			<view class="start-place">
				...
				<button class="sure" type="primary" @tap="submitAdress">确认选择</button>
			</view>
		</view>
	</view>
</template>
	...
	methods: {
		...
		getAddressName(addressObj) {
			return new Promise((res) => {
				...
				const locationObj = addressObj.latitude + ',' + addressObj.longitude
				const url = 'https://apis.map.qq.com/ws/geocoder/v1?coord_type=5&get_poi=1&output=jsonp&poi_options=page_size=1;page_index=1'
				this.$jsonp(url, {
						  key: KEY,
