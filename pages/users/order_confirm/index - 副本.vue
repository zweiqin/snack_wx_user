		...
		<view class='order-submission'>
			<view class="allAddress" :style="store_self_mention ? '':'padding-top:10rpx'" v-if="!virtual_type">
				...
				<view class='address acea-row row-between-wrapper' @tap='onAddress' v-if='shippingType == 0'>
					...
					<view class='addressCon' v-if="addressMap.real_name">
						<view class='name'>{{addressMap.real_name}}
							<text class='phone'>{{addressMap.phone}}</text>
						</view>
						<view class="line1">
				...
				<view class='line'>
					...
					<view class="">
						<uni-card :is-shadow="false">
							...
							<w-time-picker ref="picker" @confirm="onConfirm" @cancel="onCancel" :timeArr="['08:00','10:00','17:00','21:00']" :afterDays="7" :startHour='8' :endHour='21' :step="60" :afterHours="0"></w-time-picker>
						</uni-card>
					</view>
...
<script>
	...
	export default {
		...
		methods: {
			handlePicker(){
				if(!this.addressMap.latlng||!this.addressMap.poiaddress) return uni.showToast({
					title: '请先选择配送地点',
					icon: 'error',
					duration: 2000
				})
